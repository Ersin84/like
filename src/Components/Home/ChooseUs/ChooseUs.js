        ...
        <div className="grid items-center md:grid-cols-2">
          <div>
            ...
            <p className="mb-8 text-gray-500">
              Like with us, you have a trip full of experiences. With
              Like trip, booking accommodation, resort villas, hotels, private
              houses, apartments... becomes fast, convenient and easy.
            </p>
            <button className="btn-primary">Become an Like trip</button>
          </div>
          <div>
            <img
              className="mt-10"
